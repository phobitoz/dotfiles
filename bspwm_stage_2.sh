...
echo ""
sudo apt install fonts-firacode fonts-cantarell cava rofi lxappearance nitrogen polybar picom compton kitty lsd betterlockscreen flameshot neofetch git ranger -y
echo ""
...
compton &
echo ""
echo -e "${White} [${Cyan}+${White}] Composer configured ${Cyan}(compton.conf)${White}"
sleep 2
exit ;;

2)
sudo rm -rf /home/${user}/.config/picom
...
picom &
echo ""
echo -e "${White} [${Cyan}+${White}] Composer configured ${Cyan}(picom.conf)${White}"
sleep 2
exit ;;
